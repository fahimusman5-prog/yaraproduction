...
export function ContactPage() {
  ...
  const contacts = [
    { icon: MessageCircle, title: t("contact.sriLankaWhatsApp"), text: "+94 74 126 6855", href: createWhatsAppLink(t("contact.helpMessage"), "sri-lanka") },
    { icon: MessageCircle, title: t("contact.uaeWhatsApp"), text: "+971 54 370 2924", href: createWhatsAppLink(t("contact.helpMessage"), "uae") },
    ...
    { icon: Mail, title: t("contact.email"), text: "hello@yaraskincare.com", href: "mailto:hello@yaraskincare.com" }
  ];
    ...
    <div className="page-shell py-14 sm:py-20">
      ...
      <div className="mt-12 grid overflow-hidden rounded-[2.4rem] bg-white shadow-soft lg:grid-cols-[1.15fr_0.85fr]">
        <div className="p-7 sm:p-10 lg:p-12">
          ...
          {sent && <div role="status" className="mt-6 rounded-2xl bg-[#e8f8ed] p-4 text-sm text-[#176b38]">{t("contact.sent")}</div>}
