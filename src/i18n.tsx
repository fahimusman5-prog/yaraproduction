...
const en = {
  ...
  checkout: {
    ...
    catalogUnavailable: "Live inventory is temporarily unavailable. Please refresh the shop before checking out.",
...
const fullTa = mergeTree(ta, {
  ...
  checkout: { emptyEyebrow: "Checkout செய்ய இன்னும் எதுவும் இல்லை", emptyTitle: "உங்கள் ஆர்டர் கடையில் தொடங்குகிறது.", browse: "பொருட்களை பார்க்க", eyebrow: "பாதுகாப்பானதும் தனிப்பட்டதும்", copy: "உங்கள் சுய பராமரிப்பு பயணத்தை முடிக்கிறது", keepUpdated: "சிறப்பு பொருட்கள் மற்றும் சலுகைகள் பற்றி எனக்கு தெரிவிக்கவும்", payhere: "PayHere மூலம் பாதுகாப்பாக செலுத்துங்கள்", payhereCopy: "கார்டு விவரங்கள் PayHere-ன் பாதுகாப்பான hosted checkout-ல் மட்டுமே உள்ளிடப்படும்.", preparing: "பாதுகாப்பான checkout தயார் செய்யப்படுகிறது...", encrypted: "குறியாக்கப்பட்ட checkout · ஆர்டர் உதவி", error: "ஆர்டர் செய்ய முடியவில்லை.", catalogUnavailable: "நேரடி சரக்கு தகவல் தற்காலிகமாக கிடைக்கவில்லை. Checkout செய்யும் முன் shop-ஐ refresh செய்யுங்கள்.", emailPlaceholder: "you@example.com" },
...
const fullAr = mergeTree(ar, {
  ...
  checkout: { emptyEyebrow: "لا يوجد ما يمكن دفعه بعد", emptyTitle: "يبدأ طلبك من المتجر.", browse: "تصفحي المنتجات", eyebrow: "محمي وخاص", copy: "إكمال رحلة العناية الذاتية", keepUpdated: "أرغب في تلقي أخبار المنتجات والعروض الخاصة", payhere: "ادفعي بأمان عبر PayHere", payhereCopy: "يتم إدخال بيانات البطاقة فقط داخل صفحة PayHere الآمنة.", preparing: "جار تجهيز الدفع الآمن...", encrypted: "دفع مشفر · دعم الطلبات", error: "تعذر إرسال الطلب.", catalogUnavailable: "معلومات المخزون المباشر غير متاحة مؤقتا. يرجى تحديث المتجر قبل الدفع.", emailPlaceholder: "you@example.com" },
