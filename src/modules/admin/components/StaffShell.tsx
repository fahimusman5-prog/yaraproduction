...
import { BarChart3, Boxes, ChevronRight, FolderHeart, FolderTree, LayoutDashboard, LogOut, Mail, Menu, Package, ShoppingBag, Store, Users, X, Star, Truck } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/commerce", label: "Commerce", icon: Truck },
